<h2 style="font-weight:bold;
		   font-size:20px">
	<?php echo \__("newCampaignToScheduleTitle"); ?>
</h2>
<p><?php echo \__("newCampaignToScheduleMessage", ["broadcasterName" => $this->broadcasterName]); ?></p>
<?php
...
<table style="margin: 50px 0;
	...
	<tr>
		<td style="width:300px;
				   text-align:right;
				   padding:0 5px 0 0;">
			<?php echo \__("campaignName"); ?>
		</td>
		<td style="width:300px;
				   font-weight: bold;
				   padding:0 0 0 5px;">
			<?php echo $this->campaignName; ?>
		</td>
	</tr>
	<tr>
		<td style="width:300px;
